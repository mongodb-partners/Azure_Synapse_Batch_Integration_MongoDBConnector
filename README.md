...
- Copy the connection url  and replace <username> with the Database user and <password> with the Database password, that was added as part of prerequisite “*1. MongoDB Atlas cluster setupv”, step # 4 “vCreate a Database user*”. Make sure the database user has a ”*Read and write to any database*” built-in role attached.
